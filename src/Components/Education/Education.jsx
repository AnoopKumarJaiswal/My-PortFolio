      ...
      <div className="relative">
        ...
        {education.map((edu, index) => (
          ...
          >
            ...
            {/* Content Section */}
            <div
              className={`relative w-full sm:max-w-md p-4 sm:p-8 rounded-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] transform transition-transform duration-300 hover:scale-105 ${
